  ...
  return (
    ...
    >
      ...
      <div className="mt-10 flex flex-col items-center justify-center sm:mt-0">
        ...
        >
          <AnimatedTitle
            text={"Hi I'm Deepanshu Goel."}
            className={
              "mb-1 px-10 text-left text-[40px] font-bold leading-[0.9em] tracking-tighter text-[#e4ded7] sm:text-[45px] md:mb-16 md:px-0 md:text-[60px] lg:text-[80px]"
            }
            wordSpace={"mr-[10px]"}
