      ...
      <div className="mx-auto  flex w-[90%] flex-col items-center justify-center pt-10 md:pt-0">
        ...
        >
          <AnimatedWords
            title={"contact"}
            style={
              "md:flex max-w-[250px] hidden  flex-col items-start text-left text-[100px] font-extrabold uppercase leading-[0.9em] text-[#e4ded7] sm:max-w-full sm:flex-row sm:items-center sm:justify-center sm:text-center sm:text-[150px] md:text-[150px] lg:text-center lg:text-[120px] xl:text-[250px]"
            }
          />
        </div>
        ...
        <div className="mt-20 flex w-full flex-col items-end justify-center gap-16 sm:mt-32 sm:gap-12 md:mt-40 md:flex-row md:items-start md:justify-between lg:mt-12 lg:max-w-[1440px]">
          <div className=" flex w-[350px] max-w-[90%] flex-col items-end text-right text-[14px] font-semibold uppercase text-[#e4ded7] sm:w-[350px] sm:text-[14px] md:w-[310px] md:items-start md:text-left md:text-[16px] lg:w-[420px] lg:text-[16px]">
            ...
            />
            <div className="mt-10">
              <Link href="mailto:symaticvisuals02@gmail.com">
                <AnimatedTitle
                  text={"symaticvisuals02@gmail.com"}
                  className={
                    " text-[14px] font-bold lowercase text-[#e4ded7] sm:text-[20px] md:text-[16px] lg:text-[28px]"
                  }
                  wordSpace={"mr-[0.25em]"}
                  charSpace={"mr-[0.01em]"}
                />
          ...
          <div className="flex gap-10 text-[16px] font-bold text-[#e4ded7]  sm:gap-14 sm:text-[24px] md:gap-10 md:text-[16px] lg:gap-20 lg:text-[28px]">
            <Link
              href="https://github.com/symaticvisuals"
              target="_blank"
            ...
            <Link
              href="https://linkedin.com/in/deepanshuweb"
              target="_blank"
            ...
            <Link
              href="https://peerlist.io/deepanshuweb"
              target="_blank"
              aria-label="View Peerlist Profile"
            >
              <AnimatedTitle
                text={"PEERLIST "}
                className={
